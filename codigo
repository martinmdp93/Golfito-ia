...
function analizarSwingConGemini(driveFileId) {
  try {
    ...
    const prompt = "Sos un coach profesional de golf con 20 anos de experiencia analizando swings amateurs.\n\nTAREA 1 — DETECTAR ANGULO:\n- \"perfil\": camara de costado\n- \"frontal\": camara de frente\nUsa SOLO \"perfil\", \"frontal\" o \"desconocido\".\n\nTAREA 2 — ANALIZAR:\nSi PERFIL: setup alineacion, takeaway, plano backswing, zona impacto, follow through.\nSi FRONTAL: setup postura, grip, cabeza, peso, contacto.\nReporta SOLO el error mas critico.\n\nResponde EXCLUSIVAMENTE en JSON valido sin texto adicional:\n{\"angulo\":\"<perfil|frontal|desconocido>\",\"error_principal\":\"...\",\"area\":\"<Driver|Hierros|Approach|Putting|Bunker|General>\",\"severidad\":\"<leve|moderado|importante>\",\"detalles\":\"...\",\"recomendacion\":\"...\"}";
